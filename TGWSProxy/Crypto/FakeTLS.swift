...
enum FakeTLS {
    ...
    static func verifyClientHello(_ data: Data, secret: Data) -> (clientRandom: Data, sessionID: Data, timestamp: UInt32)? {
        ...
        let expected256 = Data(HMAC<SHA256>.authenticationCode(for: zeroed, using: SymmetricKey(data: secret)))
    ...
    static func buildServerHello(secret: Data, clientRandom: Data, sessionID: Data) -> Data {
        ...
        let serverRandom = Data(HMAC<SHA256>.authenticationCode(for: hmacInput, using: SymmetricKey(data: secret)))
